var mongoose = require('mongoose')
  ...
  , coinsmarkets = require('./markets/coinsmarkets')
  , stocksexchange = require('./markets/stocksexchange');
...
function get_market_data(market, cb) {
  switch(market) {
    ...
    case 'yobit':
      ...
      break;
    case 'coinsmarkets':
      coinsmarkets.get_data(settings.markets.coin, settings.markets.exchange, function(err, obj){
        return cb(err, obj);
      });
      break;
    case 'stocksexchange':
    stocksexchange.get_data(settings.markets.coin, settings.markets.exchange, function(err, obj){
      return cb(err, obj);
    });
    break;
    case 'empoex':
